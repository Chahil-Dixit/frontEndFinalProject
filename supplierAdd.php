...
<div class="container mt-3">
    <div class="card">
        ...
        <div class="card-body">
            <form name="supplierForm" action="#" id="supplierForm" method="post" autocomplete="off">
    ...
    window.onload = function () {
        ...
        $(document).on("click", "#submit", function () {
            if ($("#supplierForm").valid()) {
                ...
                $.ajax({
                    type: "POST",
                    url: base_url + "controller/supplierController.php?name=add",
                    ...
                    success: function (data) {
                        ...
                        if (data.status) {
                            ...
                            $('.resetBtn').click();
                            window.location = base_url + 'supplierView.php';
                        } else {
                            console.log('error');
